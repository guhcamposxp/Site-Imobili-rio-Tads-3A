        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <div class="card card-register mx-auto mt-5">
                    <div class="card-header cardRegistro">Visualizar Filial</div>
                    <div class="card-body">
                            <div class="form-group col-lg-12 divContato">
                                ...
                                <div class="form-row">
                                    <div class="col-md-8">
                                        ...
                                        <input class="form-control" readonly="true" name="filialNome" id="filialNome" type="text" value="${lista.filialNome}">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">CNPJ</label>
                                        <input class="form-control maskCNPJ" readonly="true" name="filialCnpj" id="filialCnpj" type="text" aria-describedby="nameHelp" placeholder="00.000.000/0000-00" value="${lista.filialCnpj}">
                                    </div>
                                    <div class="col-md-8">
                                        <label for="">Rua</label>
                                        <input class="form-control" readonly="true" name="filialRua" id="filialRua" type="text" value="${lista.filialRua}" >
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">Número</label>
                                        <input class="form-control" readonly="true" name="filialNum" id="filialNum" type="text" value="${lista.filialNum}">
                                    </div>
                                    <div class="col-md-3">
                                        <label for="">Cep</label>
                                        <input class="form-control maskCEP" readonly="true" name="filialCep" id="filialCep" type="text" placeholder="00000-000" value="${lista.filialCep}">
                                    </div>

                                    <div class="col-md-5">
                                        <label for="">Bairro</label>
                                        <input class="form-control" readonly="true" name="filialBairro" id="filialBairro" type="text" value="${lista.filialBairro}">
                                    </div>
                                    <div class="col-md-5">
                                        <label for="">Cidade</label>
                                        <input class="form-control" readonly="true" name="filialCidade" id="filialCidade" type="text" value="${lista.filialCidade}">
                                    </div>
                                    <div class="col-md-5">
                                        <label for="">Estado</label>
                                        <input class="form-control" readonly="true" name="filialEstado" id="filialEstado" type="text" value="${lista.filialEstado}">
                                    </div>
                                </div>
                            </div>
                        <hr/>
